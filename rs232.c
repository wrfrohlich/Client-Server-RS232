...
int RS232_PollComport(int comport_number, char *buf, int size_file)
{
  int n;
...
/* "warning: dereferencing type-punned pointer will break strict aliasing rules" */
  ...
  ReadFile(Cport[comport_number], buf, size_file, (LPDWORD)((void *)&n), NULL);
...
void RS232_cputs(int comport_number, char *text)  /* sends a string to serial port */
{
